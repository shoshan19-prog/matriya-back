...
const RAG_MEASUREMENT_SCHEMA_RULES =
  ...
  'If not an explicit measurement/comparison request, do NOT return JSON; answer in normal prose. ' +
  'When schema mode is required, return strict JSON first with keys {"measurements":[],"comparisons":[],"evidence_links":[],"document_classification":[],"notes":[]}. ' +
